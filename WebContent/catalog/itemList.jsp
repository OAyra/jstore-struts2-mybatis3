...
<s:iterator value="itemList" status="status">
  <div class="result">
    ...
    <div class="productImage"><s:a href="%{itemUrl}"><img width="115" height="115" border="0" src="<%=request.getContextPath()%>/<s:property value='attribute2'/>"/></s:a></div>
    <div class="productData">
      ...
      <div class="status"><s:text name="status"/>: <s:property value="status.koName" /></div>
